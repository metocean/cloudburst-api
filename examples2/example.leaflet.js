(function() {
  ...
  basemaps = (function() {
    ...
    _results = [];
    for (_i = 0, _len = basemaps_urls.length; _i < _len; _i++) {
      url = basemaps_urls[_i];
      _results.push(get_supplementary_tileLayer(url));
    }
    return _results;
  })();
  ...
  do_appendLayers = function(layersJson, refresh_layers) {
    ...
    if ((refresh_layers == null) || refresh_layers) {
      ...
      _ref = sortByKey(layersJson, 'id', false);
  ...
  do_appendInstances = function(layerJson, refresh_instances) {
    ...
    if ((refresh_instances == null) || refresh_instances) {
      ...
      _ref = sortByKey(layerJson.instances, 'id', true);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        instance = _ref[_i];
  ...
  create_layer_table = function(map, layers, table_id) {
    var decrease, depth, dt, increase, instance, l, layer, layer_name, layer_utils, legend, legendURL, lyr, opacity_slider, remove_button, row, rowi, zoom_to_layer_button, _i, _len, _ref;
          ...
          for (_i = 0, _len = layers.length; _i < _len; _i++) {
            ...
            lyr_moments = (function() {
              ...
              for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
                t = _ref[_j];
                _results.push(moment(t, moment.ISO_8601).unix());
              }
              return _results;
            })();
  ...
  activate_layers = function(map, layers, refresh_slider) {
    var lyr, t, t_set, times, _i, _j, _k, _len, _len1, _len2, _ref;
    refresh_slider = refresh_slider != null ? refresh_slider : true;
    map.eachLayer(function(lyr) {
      var _ref;
      if (!(_ref = lyr._url, __indexOf.call(basemaps_urls, _ref) >= 0)) {
